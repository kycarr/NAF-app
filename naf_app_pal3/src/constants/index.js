export const NUM_QUESTIONS_ON_A_PAGE = 10;
export const MIN_TIME = 2 * 60;
export const TOTAL_TIME = 15 * 60;
export const TOOLBAR_HEIGHT = 70;
export const SCROLL_SPEED = 800;
export const TAF_SYMBOL = "true";
...
export const SUBMIT_SECTION_ANSWER = "SUBMIT_SECTION_ANSWER";
export const SEND_TEST_FINISH = "SEND_TEST_FINISH";
export const GO_TO_REVIEW_TEST_PAGE = "GO_TO_REVIEW_TEST_PAGE";
export const FETCH_PAL3_QUESTION = "FETCH_PAL3_QUESTION";
export const RECEIVE_PAL3_QUESTION = "RECEIVE_PAL3_QUESTION";