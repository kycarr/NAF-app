      ...
      <MuiThemeProvider>
        <div className="login-page">
          ...
          <div className="intro-instructions">
            This is the Navy Training Assessment Framework working prototype, which implements test delivery and reporting functionality for studying how to deploy future tests which may require more complex item types and/or statistical analysis.
            This prototype is unclassified and does not store FOUO data. Likewise, CAC access is currently not enabled. However, it should only be accessed by authorized users evaluating the system or participating in user studies.
            Data should not be stored on this system for permanent use and may be wiped at any time during prototype upgrades. If you have any feedback or problems, please email our support line at: TAFsupport@ict.usc.edu
          </div>
