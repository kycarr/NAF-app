			...
			<AnimatedView>
			 <Tabs>
				...
				<TabPanel title="Most Recent">
					<MostRecentWrapper results={this.props.instructorResults} topics={this.props.instructorTopics} trainees={this.props.instructorTrainees} byTopics={this.props.instructorbyTopics}/>
				</TabPanel>
